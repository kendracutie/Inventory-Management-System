...
// Update the status of the product and set to bin, so that it will be tagged as data on the bin
$connection->query("UPDATE product SET status = 'bin' WHERE token = '$id'");
echo "<script>alert('The Product Item " . $productName . " " . $productPrice . " is successfully moved to bin.');</script>";
